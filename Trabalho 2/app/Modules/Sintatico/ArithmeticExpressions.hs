module Sintatico.ArithmeticExpressions where
{-
...
import Sintatico.Lexer (float', identifier', integer', parens', reservedOp', whiteSpace')
import Text.Parsec (Parsec, chainl1, try, (<|>))
import Sintatico.Types (Expr (..), TCons (..))
